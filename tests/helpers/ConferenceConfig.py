...
class ConfIds:
    ...
    def __init__ (self, conf_name, year):
        ...
        self.CONFIG_ID = self.CONF_ID + "/Reviewers/-/Assignment_Configuration"
        self.ASSIGNMENT_ID = self.CONF_ID + "/Reviewers/-/Paper_Assignment"
        self.AGGREGATE_SCORE_ID = self.CONF_ID + "/Reviewers/-/Aggregate_Score"
        self.CUSTOM_LOAD_INV_ID = self.CONF_ID + "/Reviewers/-/Custom_Load"
        # self.CONSTRAINTS_INV_ID = self.CONF_ID + "/-/Constraints"
        self.CONFLICTS_INV_ID = self.CONF_ID + "/Reviewers/-/Conflict"
