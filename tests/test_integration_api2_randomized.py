...
def test_integration_basic(openreview_context, celery_app, celery_worker):
    ...
    conference_id = "ICMM.cc/2019/Conference"
    num_reviewers = 10
    num_papers = 10
    reviews_per_paper = 3
    max_papers = 5
    ...
    config = {
        ...
        "solver":  { 'value': "Randomized" },
        "randomized_probability_limits": { 'value': "0.5" },
    }
...
def test_integration_supply_mismatch_error(
    ...
    conference_id = "ICMM.cc/2021/Conference"
    num_reviewers = 10
    num_papers = 10
...
def test_integration_demand_out_of_supply_range_error(
    ...
    conference_id = "ICMM.cc/2035/Conference"
    num_reviewers = 10
    num_papers = 10
    reviews_per_paper = 3
    max_papers = 5
...
def test_integration_no_scores(openreview_context, celery_app, celery_worker):
    ...
    conference_id = "ICMM.cc/2020/Conference"
    num_reviewers = 10
    num_papers = 10
    reviews_per_paper = 3
    max_papers = 5
